...
class _ScoreScreenState extends State<ScoreScreen>
  ...
  void initState() {
    ...
    _ma = AnimationController(
        vsync: this, duration: const Duration(milliseconds: 500));
    _sa = AnimationController(
        vsync: this, duration: const Duration(milliseconds: 700));
    _mf = CurvedAnimation(parent: _ma, curve: Curves.easeOut);
    _ms = Tween<Offset>(begin: const Offset(0, 0.2), end: Offset.zero)
        .animate(CurvedAnimation(parent: _ma, curve: Curves.easeOut));
    _ss = Tween<double>(begin: 0.3, end: 1.0)
        .animate(CurvedAnimation(parent: _sa, curve: Curves.elasticOut));
    _ma.forward();
 ...
 Future<void> _unlockNextLesson() async {
  ...
  String get _next {
    switch (widget.chapter.id) {
      case 1:
        return 'Few Basics of English';
      case 2:
        return 'Pronunciation (उच्चारण)';
      case 3:
        return 'Vocabulary & Pronunciation';
      case 4:
        return 'WH Family';
      case 5:
        return 'Parts of Speech (शब्द भेद)';
      case 6:
        return 'Noun (संज्ञा)';
      case 7:
        return 'Pronoun (सर्वनाम)';
      case 8:
        return 'Adjective (विशेषण)';
      case 9:
        return 'Verbs (क्रियाएँ)';
      case 10:
        return 'Adverbs (क्रिया विशेषण)';
      case 11:
        return 'Interjection (विस्मयादिबोधक)';
      case 12:
        return 'Articles (A/An, The)';
      case 13:
        return 'Prepositions (सम्बन्ध सूचक अव्यय)';
      case 14:
        return 'Determiners (निर्धारक)';
      case 15:
        return 'Simple Sentences (सरल वाक्य)';
      case 16:
        return 'There (देअर)';
      case 17:
        return 'Position Sense (स्थिति का ज्ञान)';
      case 18:
        return 'Tense (काल)';
      case 19:
        return 'It (इट)';
      case 20:
        return 'Modals (मोडाल्स)';
      case 21:
        return 'Conjunctions (समुच्चय बोधक अव्यय)';
      case 22:
        return 'Imperative Sentences (आज्ञा सूचक वाक्य)';
      case 23:
        return 'Let (करने देना)';
      case 24:
        return 'Causative Verbs (Get & Make)';
      case 25:
        return 'Active & Passive Voice';
      case 26:
        return 'Special Cases (विशेष प्रकार के वाक्य)';
      case 27:
        return 'Fillers (अटकाव के शब्द)';
      case 28:
        return 'Question Tags (है ना? नहीं क्या?)';
      case 29:
        return 'Phrasal Verbs (फ्रेजल वर्ब्स)';
      case 30:
        return 'Prepositional Phrases (पूर्वसर्ग वाक्यांश)';
      case 31:
        return 'Confusing Similar Words';
      case 32:
        return 'One Word Substitutions (पूरा वाक्य सिर्फ एक शब्द में)';
      case 33:
        return 'Special & Complex Sentences';
      case 34:
        return 'Extensive Translation (विस्तृत अनुवाद)';
      case 35:
        return 'Objective Exercises (लक्ष्य आधारित अभ्यास)';
      case 36:
        return 'Sentence Correction Exercises (वाक्य सुधार अभ्यास)';
      case 37:
        return 'Mixed Practice Exercise (मिश्रित अभ्यास)';
      case 38:
        return 'Mixed Test Papers (मिश्रित टेस्ट पेपर्स)';
      case 39:
        return 'Translation Exercises (अनुवाद अभ्यास)';
      case 40:
        return 'Written Conversations';
      case 41:
        return 'Few English Passages';
      case 42:
        return 'Idioms & Proverbs';
      case 43:
        return 'Written Interviews (इंटरव्यू की तैयारी)';
      case 44:
        return 'English–Hindi Dictionary (शब्दकोश)';
      case 45:
        return 'अगला अध्याय जल्द आ रहा है!';
      default:
        return 'अगला अध्याय';
    }
  }
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      ...
                      Row(
                        ...
                        children: [
                          _st('⚡', '+${widget.xpEarned}', 'XP कमाए',
                              AppColors.accentGold),
                          _st('✅', '${widget.score}', 'सही', AppColors.success),
                          _st('❌', '${widget.total - widget.score}', 'गलत',
                              AppColors.error),
                        ],
                      ),
                    ]),
                          ...
                          child: Column(
                              ...
                              children: [
                                Text('अगला पाठ खुल गया!',
                                    style: AppTextStyles.labelLarge
                                        .copyWith(color: widget.accentColor)),
                                Text('अध्याय में आगे बढ़ते रहें।',
                                    style: AppTextStyles.bodyMedium),
                              ]),
                        ),
                      ]),
